...
const createSchema = z.object({
  ...
  email: z.string({ required_error: 'email is required', invalid_type_error: 'Invalid email' }),
  phoneNumber: z.string({ required_error: 'phoneNumber is required', invalid_type_error: 'Invalid phoneNumber' }).optional(),
  password: z.string({ required_error: 'password is required', invalid_type_error: 'Invalid password' }),
